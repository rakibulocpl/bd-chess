...
<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Manage your all Schools') }}</flux:subheading>
    ...
    <div>
        ...
        @endsession
            ...
            <a href="{{route('schools.create')}}" class="bg-green-500 hover:bg-green-600 text-white text-xs px-3 py-1 rounded mr-2">Create school</a>
        ...
        <div class="overflow-x-auto rounded-lg shadow mt-4">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 text-left font-medium text-gray-600">EIIN</th>
                ...
                @foreach($schools as $user)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{$user->EIIN}}</td>
