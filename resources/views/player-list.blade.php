...
<div class="flex flex-col gap-6 bg-white">
    <x-public-header :title="__('Player List')" :description="__('')" />
    ...
    <div class="w-full mt-6 rounded-lg shadow p-3">
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <table id="players-table" class="min-w-full bg-white text-sm rounded-lg">
                <thead class="bg-indigo-600">
                    <tr>
                        <th class="py-3 text-left font-semibold text-white uppercase tracking-wider whitespace-nowrap">{{ __("Player Name") }}</th>
                        ...
                        <th class="py-3 text-left font-semibold text-white uppercase tracking-wider whitespace-nowrap">{{ __("Mobile Number") }}</th>
                        <th class="py-3 text-left font-semibold text-white uppercase tracking-wider whitespace-nowrap">{{ __("Date of Birth (Age)") }}</th>
                    </tr>
                </thead>
    ...
    <script>
        $(function () {
            $('#players-table').DataTable({
                ...
                ajax: '{{ route('application.playerList') }}',
                columns: [
                    { data: 'name', name: 'name', responsivePriority: 1 },
                    { data: 'school_info', name: 'school_info', responsivePriority: 2 },
                    { data: 'mobile', name: 'mobile', responsivePriority: 3 },
                    { data: 'birth_info', name: 'birth_info', responsivePriority: 4 },
